...
type: concept
subtype: method
tags: [reinforcement-learning, actor-critic, deterministic-policy-gradient, continuous-control]
created: 2026-05-29
updated: 2026-05-29
sources: 7
---
# DDPG
Deep Deterministic Policy Gradient（DDPG）是一种 off-policy、model-free 的 actor-critic 强化学习算法，它用 deterministic policy（确定性策略）的 actor 网络结合估计 Q 值的 critic 网络，把 deterministic policy gradient 与深度神经网络相结合，从而在连续动作空间中进行策略学习。
