...
type: entity
subtype: person
tags: [researcher, recommender-systems, multi-task-learning, deep-learning, reinforcement-learning, llm, reranking]
created: 2026-05-29
updated: 2026-05-29
sources: 3
---
...
研究者,工作涉及多任务深度推荐系统(MTDRS)、强化学习推荐、用户模拟以及大语言模型在推荐(如自动重排)中的应用。
