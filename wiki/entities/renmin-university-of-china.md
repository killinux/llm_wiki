...
type: entity
subtype: lab
tags: [university, china, research-institution]
created: 2026-05-29
updated: 2026-05-29
sources: 5
---
...
Renmin University of China(中国人民大学)是一所位于北京的综合性研究型大学,在 LLM-based agent 与推荐系统研究方面有相关工作。

## 在本 wiki 中的出现

- 在 [[2023-recagent-user-behavior-simulation]] 中,Renmin University of China 是 RecAgent 工作的研究机构;该工作提出用 LLM-based agent 在沙盒环境中近乎零样本地模拟用户的推荐与社交行为,并研究信息茧房与从众现象。
